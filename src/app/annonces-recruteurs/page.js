...
export default function AnnoncesRecruteurs() {
  ...
  useEffect(() => {
    const charger = async () => {
      ...
      const recIds = [...new Set(anns.map(a => a.auteur_id))];
      const { data: recs } = await supabase
        .from("recruteurs")
        .select("id,contact_telephone,nom_entreprise")
        .in("id", recIds);
      ...
      setAnnonces(anns.map(a => ({
        ...a,
        _auteur: recMap[a.auteur_id] || null,
      })));
      setLoading(false);
    };
    charger();
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <p style={{ color: "rgba(255,255,255,.6)", fontSize: ".9rem", margin: 0 }}>
            Annonces publiées directement par nos entreprises et recruteurs vérifiés
          </p>
        </div>
      </div>
        ...
        {loading ? (
          ...
          <div style={{
            ...
            <div style={{ fontWeight: 700, color: "#444", fontSize: ".95rem" }}>
              Aucune offre recruteur pour le moment
            </div>
            <p style={{ fontSize: ".85rem", marginTop: ".5rem" }}>
              Les annonces des recruteurs apparaîtront ici dès qu&apos;elles seront publiées.
            </p>
          </div>
        ) : (
          <div style={{
            ...
            {annonces.map(a => {
              ...
              const entreprise = a._auteur?.nom_entreprise || "Recruteur";
              const waUrl = tel
              ...
              return (
                ...
                >
                  ...
                  <div style={{ display: "flex", gap: ".4rem", flexWrap: "wrap" }}>
                    ...
                    <span style={{ background: "#EFF6FF", color: "#1D4ED8", fontSize: ".68rem", fontWeight: 700, padding: "3px 9px", borderRadius: "99px", border: "1px solid #BFDBFE" }}>
                      🏢 {entreprise}
                    </span>
                  </div>
